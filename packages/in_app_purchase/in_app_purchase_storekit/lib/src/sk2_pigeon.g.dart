...
class SK2ProductPurchaseOptionsMessage {
  ...
  String? introductoryOfferEligibilityJws;
  ...
  static SK2ProductPurchaseOptionsMessage decode(Object result) {
    ...
    return SK2ProductPurchaseOptionsMessage(
      ...
      introductoryOfferEligibilityJws: result[4] as String?,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(appAccountToken, other.appAccountToken) && _deepEquals(quantity, other.quantity) && _deepEquals(promotionalOffer, other.promotionalOffer) && _deepEquals(winBackOfferId, other.winBackOfferId) && _deepEquals(introductoryOfferEligibilityJws, other.introductoryOfferEligibilityJws);
  }
...
class InAppPurchase2API {
  ...
  Future<String?> appTransactionId() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.in_app_purchase_storekit.InAppPurchase2API.appTransactionId$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
